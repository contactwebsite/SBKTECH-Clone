...
export const metadata: Metadata = {
  title: 'Politique de Confidentialité | MegaDealTech',
  description: 'Politique de confidentialité de MegaDealTech Smart Security. Comment nous collectons et protégeons vos données personnelles.',
}
    ...
    <div className="bg-white min-h-screen">
      <div className="max-w-3xl mx-auto px-4 py-24">
        ...
        <div className="prose prose-sm max-w-none space-y-8 text-gray-600">
          {[
            { title: '1. COLLECTE DES DONNÉES', content: 'MegaDealTech Smart Security collecte uniquement les données nécessaires au traitement de vos commandes : nom, prénom, numéro de téléphone et adresse de livraison. Ces données sont collectées lors de votre commande sur notre site.' },
            ...
            { title: '5. VOS DROITS', content: 'Conformément à la loi marocaine 09-08 relative à la protection des personnes physiques, vous disposez d\'un droit d\'accès, de rectification et de suppression de vos données personnelles. Pour exercer ces droits, contactez-nous à : contact@MegaDealTech.com' },
            { title: '6. CONTACT', content: 'Pour toute question relative à notre politique de confidentialité, contactez-nous : Email : contact@MegaDealTech.com | Téléphone : +212 687 01 43 98' },
          ].map((section, i) => (
            <div key={i}>
