  ...
  return (
    <div className="bg-white min-h-screen">
      <div className="max-w-2xl mx-auto px-4 py-24">
        ...
        {/* العنونة الرئيسية المتواجدة في المنتصف */}
        ...
        {/* استمارة الاتصال المباشرة في منتصف الصفحة */}
        <div className="bg-white border border-gray-100 shadow-xl rounded-2xl p-6 md:p-10">
          <h2 className="text-xs font-bold uppercase tracking-[0.2em] text-black mb-6 text-center">
            ENVOYEZ UN MESSAGE
          </h2>

          <form onSubmit={handleSubmit} className="space-y-4">
            {[
              { key: 'nom', label: 'Nom complet', type: 'text', placeholder: 'Votre nom', req: true },
              { key: 'telephone', label: 'Téléphone', type: 'tel', placeholder: '06 87 01 43 98', req: false },
              { key: 'sujet', label: 'Sujet', type: 'text', placeholder: 'Objet de votre message', req: false }
            ...
            <button 
              type="submit" 
              disabled={loading} 
              className="w-full bg-black text-white py-4 text-xs font-bold uppercase tracking-[0.2em] rounded-lg hover:bg-gray-900 transition-colors disabled:opacity-50 shadow-md"
            >
