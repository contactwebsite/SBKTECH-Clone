...
export default function AccessControlDoorPage() {
  const categoryProducts = products.filter(p => p.category === 'Contrôle d\'accès porte');
    ...
    <div className="bg-white min-h-screen">
      <div className="max-w-7xl mx-auto px-4 py-24 bg-white">
        <header className="text-center mb-20">
          ...
          >
            Une sécurité absolue pour chaque entrée.
          </motion.p>
        </header>
