...
export default function AccessControlReadersPage() {
  const categoryProducts = products.filter(p => p.category === 'Lecteurs contrôle d\'accès');
    ...
    <div className="bg-white min-h-screen">
      <div className="max-w-7xl mx-auto px-4 py-24 bg-white">
        <header className="text-center mb-20">
          ...
          >
            La technologie de pointe à votre service.
          </motion.p>
        </header>
