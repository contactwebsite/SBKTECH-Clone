        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              {[
                ['/', 'Accueil'],
                ['/category/serrure-intelligente', 'Poignée Digital'],
                ['/category/coffre-fort', 'Coffre-fort'],
                ['/catalogue', 'Catalogue'],
                ['/contact', 'Contactez-nous']
              ].map(([href, name]) => (
                <li key={href}>
                  <Link href={href} className="text-gray-300 hover:text-white transition-colors tracking-wide">
                    {name}
                  </Link>
                </li>
              ))}
